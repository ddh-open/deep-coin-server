...
//	"devops-http/app/provider/shell/message"
//	"devops-http/app/provider/shell/network"
...
//	cfg  contract.Config
//	conn network.Conn
//	read map[string]chan *message.Msg // link id => channel
//	unknownRead chan *message.Msg           // read message without link
//	write       chan *message.Msg
//	lockDrop    sync.RWMutex
//	drop        map[string]time.Time
//}
//
//// New connection
//func New(cfg contract.Config) *Conn {
//	conn := &Conn{
//		cfg:         cfg,
//		read:        make(map[string]chan *message.Msg),
//		unknownRead: make(chan *message.Msg, 1024),
//		write:       make(chan *message.Msg, 1024),
...
//			base.Logger.Error("connect error: %v", zap.Any("err",err))
//			panic(err)
//		}
//	}()
//	var dial net.Conn
...
//	base.Logger.Info("%s connected", conn.cfg.Server)
//	return cn
//}
//
//func writeHandshake(conn *Conn, cfg *global.Configure) error {
//	var msg network.Msg
